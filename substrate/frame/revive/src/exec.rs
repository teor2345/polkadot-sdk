...
///
/// In the on-chain environment this would be represented by a vm module. This trait exists in
...
/// the runtime module which interfaces with the contract (the vm blob) itself.
